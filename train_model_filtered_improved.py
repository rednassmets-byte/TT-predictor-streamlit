...
print("=" * 60)
print("IMPROVED FILTERED MODEL TRAINING (YOUTH CATEGORIES)")
print("=" * 60)
...
print(f"Filtered to youth categories: {len(df)} players")
...
study = optuna.create_study(direction='maximize', study_name='filtered_rf_optimization')
...
# Save models
joblib.dump(best_model, "model_filtered_improved.pkl")
joblib.dump(category_encoder, "category_encoder_filtered_improved.pkl")
joblib.dump(rank_to_int, "rank_to_int_filtered_improved.pkl")
joblib.dump(int_to_rank, "int_to_rank_filtered_improved.pkl")
joblib.dump(feature_cols, "feature_cols_filtered_improved.pkl")
joblib.dump(ranking_order, "ranking_order_filtered_improved.pkl")
joblib.dump(scaler, "scaler_filtered_improved.pkl")

print("\nIMPROVED FILTERED MODEL SAVED!")
